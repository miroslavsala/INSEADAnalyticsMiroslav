...
fit.log.i<-lm(log(Price)~log(Carat.Weight)*Color+Cut+Color+Clarity+Polish+Symmetry+Report, data=diamond.data.testing) # the "*" sign calls the interaction between the carat and color variables
summary(fit.log.i)
